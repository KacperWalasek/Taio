...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        raise RuntimeError("Too few arguments, dataset directory path or limit is missing")
    data_dir = sys.argv[1]
    ...
    print("Train")
    remove_short(train_path,limit)
    print()
    print("Test")
    remove_short(test_path,limit)
